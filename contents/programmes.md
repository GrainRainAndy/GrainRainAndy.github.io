...
I deployed models on **Android devices with Qualcomm Snapdragon processors**, collected runtime data, and profiled execution at the operator level. In particular, I investigated bottlenecks in different operators such as convolution and attention operators, and analyzed execution efficiency across different hardware configurations.
...
<time datetime="2024-11">November 2024</time> - <time datetime="2025-04">April 2025</time>
